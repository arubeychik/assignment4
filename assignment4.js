...
function count() {
    var grooms_name = String(document.getElementById("nm").value);
    var result = document.getElementById("firstNumber").value;
    console.log(result);
    ...
    document.getElementById("final").innerHTML = 'Your price for ' + grooms_name + ' is '  + Math.ceil(result);
  }